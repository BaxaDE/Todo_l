...
urlpatterns = [
    ...
    path('categories/<slug:slug>/edit', views.CategoryEdit.as_view(), name='category-edit'),
    path('categories/<slug:slug>/delete/confirm', views.CategoryDeleteConfirmation.as_view(), name='category-delete-confirmation'),
    path('categories/<slug:slug>/delete', views.CategoryDelete.as_view(), name='category-delete'),
    path('categories/<slug:slug>/todo-items', views.TodoItemsByCategory.as_view(), name='todo-items-by-category'),
]
